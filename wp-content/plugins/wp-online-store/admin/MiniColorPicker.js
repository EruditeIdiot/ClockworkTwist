...
function initPicker(fieldName,fieldValue,depth,callFunc){
	...
	s+= "<td>&nbsp;<input type=\"text\" name=\""+fieldName+"\" id=pickedColor_"+depth+"_"+donePickerInits[depth]+"Value value=\""+fieldValue+"\" size=10 style=\"font-size:10px;\" onchange=\"setPickedColorFromForm(this)\"></td>";
	s+= "</table>";
	document.write(s);
