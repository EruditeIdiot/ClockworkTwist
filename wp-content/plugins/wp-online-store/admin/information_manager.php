...
// Include current language file, if not exists, fall use English (Why is this not a standard procedure in OsCommerce?)
  if (file_exists(DIR_FS_ADMIN.DIR_WS_INCLUDES.DIR_WS_LANGUAGES . $language . '/information.php')) {
    include(DIR_FS_ADMIN.DIR_WS_INCLUDES.DIR_WS_LANGUAGES . $language . '/information.php');
  } else {
    include(DIR_FS_ADMIN.DIR_WS_INCLUDES.DIR_WS_LANGUAGES . 'english/information.php');
  }
  global $languages;
...
// WT
  function tep_get_information_entry($information_id, $language_id = 0, $column = '') {
    global $languages_id;
    if ($language_id == 0) $language_id = $languages_id;
    //echo ("select * from " . TABLE_INFORMATION . " where information_id = '" . (int)$information_id . "' and language_id = '" . (int)$language_id . "'");
