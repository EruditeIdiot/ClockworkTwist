...
*/
  ...
  if(isset($HTTP_POST_VARS['zpage']))
  	$HTTP_GET_VARS['zpage'] = $HTTP_POST_VARS['zpage'] ;
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo HEADING_TITLE.TEXT_HELP_INSTURCTIONS.TEXT_HELP_VIDEO; if (isset($HTTP_GET_VARS['zone'])) echo '<br /><span class="smallText">' . tep_get_geo_zone_name($HTTP_GET_VARS['zone']) . '</span>'; ?></td>
