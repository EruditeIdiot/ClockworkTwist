...
define('HELP_VIDEO','');
define('HELP_TEXT','The database backup tool allows the store owner to make backups of the store database, including all customer and order information. It is recommended that regular backups of the store are created server side and downloaded to your computer in case of problems with the store.');
?>
