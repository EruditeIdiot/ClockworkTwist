...
define('HELP_VIDEO','');
define('HELP_TEXT','A simple banner management implementation that displays image or HTML based banners, and tracks impressions and clicks on a per banner basis. Each banner is assigned a group which is used for displaying random banners in the set group. This allows certain banners to be shown throughout certain locations on the overall web site layout.');
?>
