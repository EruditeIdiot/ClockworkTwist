...
define('HELP_VIDEO','');
define('HELP_TEXT','A newsletter management system that sends emails to a targeted audience, namely the customers that have given their email address when creating an account. Please refer to the knowledgebase on www.help.wponlinestore.com for more detailed information.');
?>