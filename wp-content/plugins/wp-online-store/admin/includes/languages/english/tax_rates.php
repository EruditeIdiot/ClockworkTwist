...
define('HELP_VIDEO','');
define('HELP_TEXT','The tax rate of the state your store is in. Please see the Knowledgebase on www.help.wponlinestore.com for instructions on Locations and Taxes.');
?>
