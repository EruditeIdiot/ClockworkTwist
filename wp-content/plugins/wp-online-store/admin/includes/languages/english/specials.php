...
define('HELP_VIDEO','');
define('HELP_TEXT','This section is where you add items on "Special" and set the properties for those items. The "Specials" interface is the standard admin interface with the added option of an "On/Off" button. If you click the green icon, the special is active. If you click the red icon, the special is inactive. This is nice so you can re-use specials and turn them on or off when you need to. If you click on a special, you will get the option to edit or delete it in the right column. Use the "New Product" button to add a new item on special. It will take you to the easy to use "Add New Special" page.');
?>
