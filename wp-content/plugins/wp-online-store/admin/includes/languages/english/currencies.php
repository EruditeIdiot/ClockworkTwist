...
define('HELP_VIDEO','');
define('HELP_TEXT','Your default store currency.  Set currency and exchange rates, BUT although the exchange rates of the other currencies will be updated automatically when the update tool is used, if any products have been entered in the Products section, they will need to have the prices updated manually so be sure to install the default currency first, THEN add products.');
?>
