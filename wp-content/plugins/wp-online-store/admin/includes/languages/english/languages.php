...
define('HELP_VIDEO','');
define('HELP_TEXT','This area is here for future expansion of the system. It is possible for additional languages to be added and it is something that we hope to address soon.');
?>
