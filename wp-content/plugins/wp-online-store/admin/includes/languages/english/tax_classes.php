...
define('HELP_VIDEO','');
define('HELP_TEXT','The title of your tax class, for example "taxable goods", and the description of that title. Please see the Knowledgebase on www.help.wponlinestore.com for instructions on Locations and Taxes.');
?>