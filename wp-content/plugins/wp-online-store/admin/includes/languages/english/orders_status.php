...
define('HELP_VIDEO','');
define('HELP_TEXT','Order Statuses are edited to either show the order to the customer at a certain order status level and/or allow downloads of virtual products at a certain order status level. Please see the knowledgebase on www.help.wponlinestore.com for detailed information');
?>