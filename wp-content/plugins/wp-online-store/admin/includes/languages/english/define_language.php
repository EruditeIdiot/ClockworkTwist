...
define('HELP_VIDEO','');
define('HELP_TEXT','Edit some of the labels (titles, descriptions and some content) in the language files that are used by the pages in your store. WARNING: These pages use HTML code and incorrect code or deleting some of the code will stop the page from loading correctly.');
?>
