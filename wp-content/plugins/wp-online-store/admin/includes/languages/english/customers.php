...
define('HELP_VIDEO','');
define('HELP_TEXT','The customers section holds all of the customers and orders that have been placed. The customer information can be edited, deleted, see orders, and emailed from this section. The "Search" box in the top of the page will enable you to search for a string of text in the fields last name, first name and email address of customers. The store owner can edit any customer details except the password.');
?>
