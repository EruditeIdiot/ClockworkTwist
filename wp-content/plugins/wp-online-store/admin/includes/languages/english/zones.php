...
define('HELP_VIDEO','');
define('HELP_TEXT','A listing of all zones in your store. Please see the Knowledgebase on www.help.wponlinestore.com for instructions on Locations and Taxes.');
?>