...
define('HELP_VIDEO','');
define('HELP_TEXT','(Also known as Geo Zones.) The state and tax description of your store. Please see the Knowledgebase on www.help.wponlinestore.com for instructions on Locations and Taxes.');
?>
