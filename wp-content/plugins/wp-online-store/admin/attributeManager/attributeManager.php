...
//echo $admin_dir.'includes/application_top.php';
require($admin_dir.'includes/ajax_application_top.php');

// db wrapper
require_once($admin_dir.'attributeManager/classes/amDB.class.php');

//echo "hi";
// session functions
require_once($admin_dir.'attributeManager/includes/attributeManagerSessionFunctions.inc.php');

// config
require_once($admin_dir.'attributeManager/classes/attributeManagerConfig.class.php');

// misc functions
require_once($admin_dir.'attributeManager/includes/attributeManagerGeneralFunctions.inc.php');

// parent class
require_once($admin_dir.'attributeManager/classes/attributeManager.class.php');

// instant class
require_once($admin_dir.'attributeManager/classes/attributeManagerInstant.class.php');

// atomic class
require_once($admin_dir.'attributeManager/classes/attributeManagerAtomic.class.php');

// security class
require_once($admin_dir.'attributeManager/classes/stopDirectAccess.class.php');
...
// include any prompts
require_once($admin_dir.'attributeManager/includes/attributeManagerPrompts.inc.php');
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		if(count($languages) > 1) {
			...
			?>
			&nbsp;<input type="image" <?php echo ($attributeManager->getSelectedLanaguage() == $amLanguage['id']) ? 'style="padding:1px;border:1px solid black" onClick="return false" ' :'onclick="return amSetInterfaceLanguage(\''.$amLanguage['id'].'\');" '?> src=""  border="0" title="<?=AM_AJAX_CHANGES?>" />
			<?php
			}
		}
		?>
		...
		if(false !== AM_USE_TEMPLATES) {
			...
			<div  style="padding:5px 3px 5px 0px">
				<input type="image" <?php if($attributeManager->getTemplateOrder()=='123'){echo 'style="border:1px solid #DDDDDD;"';} ?> src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_123.png" onclick="return amTemplateOrder('123');" border="0" title="" />
				<input type="image" <?php if($attributeManager->getTemplateOrder()=='abc'){echo 'style="border:1px solid #DDDDDD;"';} ?> src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_abc.png" onclick="return amTemplateOrder('abc');" border="0" title="" />
				&nbsp;
				...
				&nbsp;
				<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_load.png" onclick="return customTemplatePrompt('loadTemplate');" border="0" title="<?=AM_AJAX_LOADS_SELECTED_TEMPLATE?>" />
				&nbsp;
				<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_save.png" onclick="return customPrompt('saveTemplate');" border="0" title="<?=AM_AJAX_SAVES_ATTRIBUTES_AS_A_NEW_TEMPLATE?>" />
				&nbsp;
				<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_rename.png" onclick="return customTemplatePrompt('renameTemplate');" border="0" title="<?=AM_AJAX_RENAMES_THE_SELECTED_TEMPLATE?>" />
				&nbsp;
				<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_delete.png" onclick="return customTemplatePrompt('deleteTemplate');" border="0" title="<?=AM_AJAX_DELETES_THE_SELECTED_TEMPLATE?>" />
				&nbsp;
			</div>
			<?php
		}
...
?>
	<table width="100%" border="0" cellspacing="0" cellpadding="3">	
		<tr class="header">
			<td width="50" align="center">
				<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_plus.gif" onclick="return amShowHideAllOptionValues([<?php echo implode(',',array_keys($allProductOptionsAndValues));?>],true);" border="0" />
				&nbsp;
				<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_minus.gif" onclick="return amShowHideAllOptionValues([<?php echo implode(',',array_keys($allProductOptionsAndValues));?>],false);" border="0" />
			</td>
			<td>
				<?=AM_AJAX_NAME?>
			</td>
	...
	?>
			<tr class="option">
				<td align="center">
				<input type="image" border="0" id="show_hide_<?php echo $optionId; ?>" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_plus.gif" onclick="return amShowHideOptionsValues(<?php echo $optionId; ?>);" />
				...
				<td align="right">
					...
					<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_add.png" value="Add" border="0" onclick="return amAddOptionValueToProduct('<?php echo $optionId?>');" title="<?php echo htmlspecialchars(sprintf(AM_AJAX_ADDS_ATTRIBUTE_TO_OPTION, $optionInfo['name'])); ?>" />
				
					<input type="image" title="<? echo htmlspecialchars(sprintf(AM_AJAX_ADDS_NEW_VALUE_TO_OPTION,$optionInfo['name'])) ?>" border="0" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_add_new.png" onclick="return customPrompt('amAddNewOptionValueToProduct','<?php echo addslashes("option_id:$optionId|option_name:".str_replace('"','&quot;',$optionInfo['name']))?>');" />
<?php
if(false){
?>
<!--					<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_rename.png" onclick="return customTemplatePrompt('renameTemplate');" border="0" title="Renames the selected template" />-->
<?php
}
?>
					<input type="image" border="0" onClick="return customPrompt('amRemoveOptionFromProduct','<?php echo addslashes("option_id:$optionId|option_name:".str_replace('"','&quot;',$optionInfo['name']))?>');" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_delete.png" title="<? echo htmlspecialchars(addslashes(sprintf(AM_AJAX_PRODUCT_REMOVES_OPTION_AND_ITS_VALUES,$optionInfo['name'],$numValues))) ?>" />

			
					<?php
					if(AM_USE_SORT_ORDER) {
					?>	
					<input type="image" onclick="return amMoveOption('<?php echo 'option_id:'.$optionId ; ?>', 'up');" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_up.png" title="Moves option up" /> 
					<input type="image" onclick="return amMoveOption('<?php echo 'option_id:'.$optionId ; ?>', 'down');" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_down.png" title="Moves option down" /> 
					<?php
					}
					?>
				</td>
...
<!-- ----- -->
	...
	?>
			...
			<tr class="optionValue" id="trOptionsValues_<?php echo $optionId; ?>" style="display:none" >
				<td align="center">
					<img src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_arrow.gif" />
				</td>
				<td>
...
?>
					<input type="image" border="0" onClick="return customPrompt('amRemoveOptionValueFromProduct','<?php echo addslashes("option_id:$optionId|option_value_id:$optionValueId|option_value_name:".str_replace('"','&quot;',$optionValueInfo['name']))?>');" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_delete.png" title="<? echo htmlspecialchars(sprintf(AM_AJAX_PRODUCT_REMOVES_VALUE_FROM_OPTION,$optionValueInfo['name'],$optionInfo['name'])) ?>" />
					<?php
					if(AM_USE_SORT_ORDER) {
					?>	
						<input type="image" onclick="return amMoveOptionValue('<?php echo 'option_id:'.$optionId.'|option_value_id:'.$optionValueId.'|products_attributes_id:'.$optionValueInfo['products_attributes_id']; ?>', 'up');" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_up.png" title="<?=AM_AJAX_MOVES_VALUE_UP?>" /> 
						<input type="image" onclick="return amMoveOptionValue('<?php echo 'option_id:'.$optionId.'|option_value_id:'.$optionValueId.'|products_attributes_id:'.$optionValueInfo['products_attributes_id']; ?>', 'down');" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_down.png" title="<?=AM_AJAX_MOVES_VALUE_DOWN?>" />  
					<?php
					}
					?>
				</td>
	...
	<table border="0"  cellpadding="0" cellspacing="0">
		<tr>
			...
			<td align="right" valign="middle" class="newOptionPanel-button">
				<input border="0"  type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_add_new.png" onclick="return customPrompt('amAddOption');" title="<?=AM_AJAX_ADDS_NEW_OPTION?>" />
			</td>
			<td align="right" valign="middle" class="newOptionPanel-label">
			...
			<td align="right" valign="middle" class="newOptionPanel-button">
					<input border="0" type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_add_new.png" onclick="return customPrompt('amAddOptionValue');" title="<?=AM_AJAX_ADDS_NEW_OPTION_VALUE?>" />
			</td>
			...
			<td align="right" valign="middle" class="newOptionPanel-button">
				<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_add.png" value="Add" onclick="return amAddAttributeToProduct();" title="<?=AM_AJAX_ADDS_ATTRIBUTE_TO_PRODUCT?>" border="0"  />
			</td>
		</tr>
	</table>			
<?php
...
?>
	<table width="100%" border="0" cellspacing="0" cellpadding="3">	
		...
		<tr class="option">
			<td align="center">
			<input type="image" border="0" id="show_hide_9999" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_plus.gif" onclick="return amShowHideOptionsValues(9999);" />
			</td>
<?php
  if (tep_db_num_rows($q)>0) {
...
?>      
			<td align="right">
				...
				<input type="image" border="0" onClick="return customPrompt('amRemoveStockOptionValueFromProduct','<?php echo addslashes("option_id:$rec[products_stock_id]")?>');" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_delete.png" title="<?=AM_AJAX_ADDS_ATTRIBUTE_TO_PRODUCT?>" />
			</td>
		</tr>
<?php
    }
...
?>
			...
			<td valign="top">
				<input type="image" src="<?php echo HTTP_SERVER.DIR_WS_CATALOG.'admin/';?>attributeManager/images/icon_add.png" value="Add" onclick="return root('<?php echo implode(",", $dropDownOptions); ?>');" title="<?=AM_AJAX_UPDATE_OR_INSERT_ATTRIBUTE_COMBINATIONBY_QUANTITY?>" border="0"  /><br/>t: 
			</td>
		</tr>
	</table>			
<?php
