var placeHolderDiv;
var url = url_to_admin+"attributeManager/attributeManager.php";
var debug = false;
...
function checkBox(id) {
    ...
    if(check[id] != true) //if a value is not true, use this rather than == false, 'cos the first time no value will be set and it will be undefined, not true or false
        {
        document.getElementById('imgCheck_' + id).src = url_to_admin+"attributeManager/images/icon_up.png"; //change the image
        ...
        {
        document.getElementById('imgCheck_' + id).src = url_to_admin+"attributeManager/images/icon_down.png";
		...
		for(var a in openClosedState) {
			...
			if (reg.test(allTrs[i].id)) {
				if(true == openClosedState[a]) {
					...
					getElement("show_hide_"+a).src = url_to_admin+"attributeManager/images/icon_minus.gif";
				}
				else {
					allTrs[i].style.display =  "none";
					getElement("show_hide_"+a).src = url_to_admin+"attributeManager/images/icon_plus.gif";
				}
			}
		}
	}
...
function amShowHideAttributeManager() {
	...
	getElement('showHideAll').src = url_to_admin+"attributeManager/images/icon_"+ ((true == attributeManagerClosedState) ? "minus.gif" : "plus.gif");
	return false;
}
...
function amShowHideOptionsValues(id) {
	...
	if(true == openClosedState[id]){
		getElement("show_hide_"+id).src = url_to_admin+"attributeManager/images/icon_plus.gif";
		openClosedState[id] = false;
	}
	else{
		getElement("show_hide_"+id).src = url_to_admin+"attributeManager/images/icon_minus.gif";
