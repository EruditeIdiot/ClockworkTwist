...
require_once(DIR_FS_ADMIN.'attributeManager/classes/attributeManagerConfig.class.php');
require_once(DIR_FS_ADMIN.'attributeManager/classes/amDB.class.php');
require_once(DIR_FS_ADMIN.'attributeManager/classes/stopDirectAccess.class.php');
