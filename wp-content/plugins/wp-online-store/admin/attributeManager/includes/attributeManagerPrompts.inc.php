...
$return .='
	<tr>
		<td align="right">'. tep_image(HTTP_SERVER.DIR_WS_CATALOG_LANGUAGES . $amLanguage['directory'] . '/images/' . $amLanguage['image'], $amLanguage['name']).'</td>
...
if(AM_USE_QT_PRO) {
	$return .='	<td>'.AM_AJAX_TRACK_STOCK.' <img src="'.HTTP_SERVER.DIR_WS_CATALOG.'admin/attributeManager/images/icon_up.png" id="imgCheck_1" onclick="checkBox(1)" title="'.AM_AJAX_TRACK_STOCK_IMGALT.'" />
