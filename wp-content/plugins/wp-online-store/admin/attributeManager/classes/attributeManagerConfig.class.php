...
require_once(DIR_FS_ADMIN.'attributeManager/classes/amDB.class.php');
require_once(DIR_FS_ADMIN.'attributeManager/includes/attributeManagerSessionFunctions.inc.php');

if(file_exists(DIR_FS_ADMIN.'attributeManager/languages/'.$_SESSION['language'].'/attributeManager.php'))
 include_once(DIR_FS_ADMIN.'attributeManager/languages/'.$_SESSION['language'].'/attributeManager.php');
else
 include_once(DIR_FS_ADMIN.'attributeManager/languages/'.'english'.'/attributeManager.php');
