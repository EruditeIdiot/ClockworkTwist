...
if(isset($HTTP_GET_VARS['wpols_order']))  $HTTP_GET_VARS['order']=$HTTP_GET_VARS['wpols_order'];

if(isset($HTTP_GET_VARS['wpols_id']))  $HTTP_GET_VARS['id']=$HTTP_GET_VARS['wpols_id'];
...
//tep_redirect(HTTP_SERVER.DIR_WS_HTTP_CATALOG.'/downloads/'.$downloads['orders_products_filename']);
tep_redirect(tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, 'file=' . $downloads['orders_products_filename'] . '&' . 'order_id=' . $HTTP_GET_VARS['order'], 'SSL'));
