...
*/
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'process') && isset($HTTP_POST_VARS['formid']) && ($HTTP_POST_VARS['formid'] == $sessiontoken)) {
    ...
    if ($error == false) {
      ...
      $email_body = sprintf(TEXT_EMAIL_INTRO, $to_name, $from_name, stripslashes($product_info['products_name']), STORE_NAME) . "\n\n";
...
<h1><?php echo sprintf(HEADING_TITLE, stripslashes($product_info['products_name'])); ?></h1>
