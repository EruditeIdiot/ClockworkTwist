...
*/
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'send') && isset($HTTP_POST_VARS['formid']) && ($HTTP_POST_VARS['formid'] == $sessiontoken)) {
    ...
    $name = tep_db_prepare_input($HTTP_POST_VARS['wpols_name']);
    $email_address = tep_db_prepare_input($HTTP_POST_VARS['wpols_email']);
  ...
  <div class="contentText">
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_input_field('wpols_name'); ?></td>
      </tr>
      <tr>
        <td class="fieldKey"><?php echo ENTRY_EMAIL; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('wpols_email'); ?></td>
      </tr>
      <tr>
