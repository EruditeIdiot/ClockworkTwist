...
// class methods
    ...
    function selection() {
      ...
      return array('id' => $this->code,
                   'module' => $this->public_title . (!empty($this->_payment_method_image) ? '<br />' . tep_image(HTTP_SERVER . DIR_WS_HTTP_CATALOG . 'ext/modules/payment/moneybookers/logos/' . $this->_payment_method_image, $this->public_title) : ''));
    }
