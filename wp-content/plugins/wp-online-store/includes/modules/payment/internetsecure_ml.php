<?php
/*
  $Id: internetsecure_ml.php,v 1.8 2009/08/06  15:46:08 hpdl Exp $
*/
$internetsecure_ml_code = 'All right reserved by IMC group';
...
// class constructor
    function internetsecure_ml() {
      ...
      $this->identifier = 'osCommerce InternetSecure MerchantLink v2.0';
...
// class methods
    ...
    function selection() {
	  $img_visa = HTTP_SERVER.DIR_WS_IMAGES.'visa.gif';
    $img_mc = HTTP_SERVER.DIR_WS_IMAGES.'/mastercard.gif';
    $img_discover = HTTP_SERVER.DIR_WS_IMAGES.'discover.gif';
    $img_amex = HTTP_SERVER.DIR_WS_IMAGES.'amex.gif';
    $img_IS = HTTP_SERVER.DIR_WS_IMAGES.'internetsecure.jpg';
	  $cc_explain = MODULE_PAYMENT_INTERNETSECURE_CC_DESCRIPTION;
    $IS_cc_txt = sprintf(MODULE_PAYMENT_INTERNETSECURE_CC_TEXT,
                              tep_image($img_IS,' InternetSecure ','','','align="absmiddle"'),
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function process_button() {
      	global  $HTTP_SERVER_VARS, $customer_id, $order, $customer_province, $us_conversion_rate,
...
// lets start with the email confirmation
	  ...
	  $email_order .= 'GST Number: 85235-8217-RT001' . "\n\n";
