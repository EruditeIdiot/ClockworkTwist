...
// class methods
    function quote($method = '') {
      ...
      $this->quotes = array('id' => $this->code,
                            ...
                            'methods' => array(array('id' => $this->code,
                                                     ...
                                                     'cost' => MODULE_SHIPPING_FLATRATE2_COST)));
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Flat Rate 2 Shipping', 'MODULE_SHIPPING_FLATRATE2_STATUS', 'True', 'Do you want to offer flat rate 2 rate shipping?', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
