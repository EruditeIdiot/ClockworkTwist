  ...
  class ot_quantity_discount {
   ...
   function pre_confirmation_check($order_total) {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('&copy; That Software Guy<br /><a href=\"http://www.thatsoftwareguy.com/donate.html\" target=\"_blank\">Donate</a>&nbsp;&nbsp;<a href=\"http://www.thatsoftwareguy.com/osc_quantity_discounts.html\" target=\"_blank\">Help</a><br /><br />This module is installed', 'MODULE_ORDER_TOTAL_QUANTITY_DISCOUNT_STATUS', 'true', '', '6', '1','tep_cfg_select_option(array(\'true\'), ', now())");
