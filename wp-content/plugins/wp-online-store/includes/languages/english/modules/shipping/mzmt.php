...
define('MODULE_SHIPPING_MZMT_TEXT_DESCRIPTION', 'Multiple geo zone shipping with multiple tables to each geo zone. To add additional zones. <b>
<a href="'.tep_href_link(FILENAME_CONFIGURATION,'gID=22').'" target="_blank">Click here>></a></b>');
