...
// PWA BOF
define('TEXT_GUEST_INTRODUCTION', '<strong>QUICK CHECKOUT:</strong><br> Would you like to check out without creating a customer account? Please note that all of our customer features will not be available if you don’t create an account. If you still wish to simply checkout please click the checkout button below.');
// PWA BOF
